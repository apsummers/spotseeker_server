...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpotAvailableHours.valid_on'
        db.add_column('spotseeker_server_spotavailablehours', 'valid_on',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpotAvailableHours.valid_until'
        db.add_column('spotseeker_server_spotavailablehours', 'valid_until',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpotAvailableHours.valid_on'
        db.delete_column('spotseeker_server_spotavailablehours', 'valid_on')

        # Deleting field 'SpotAvailableHours.valid_until'
        db.delete_column('spotseeker_server_spotavailablehours', 'valid_until')
